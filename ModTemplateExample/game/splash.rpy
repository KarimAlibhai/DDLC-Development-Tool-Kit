...
init -100 python:
    ...
    renpy.start_predict("monika *")
    renpy.start_predict("sayori *")
    renpy.start_predict("natsuki *")
    renpy.start_predict("yuri *")
...
###Addition Here###
label main_menu: #This makes the main menu not exist at all
    return